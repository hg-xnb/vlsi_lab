#!/bin/ksh
# This script was generated Mon May 12 10:32:34 2025 by:
#
...
#	/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run-check-not.xcn \
#	-assura_run_dir /media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT \
#	-assura_run_name run-check-not -rcxdir \
#	/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run-check-not \
#	-xy_coordinates c,r -type full -temperature 25.0 -sub_node_char # \
#	-res_models no -rcxfs_type none -parasitic_res_models comment \
#	-parasitic_cap_models no -output_net_name_space layout -output \
#	/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run-check-not/extview.tmp \
...
#	/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run-check-not.gnx,/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run-check-not.gdx
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
...
##NETS_FILE=/dev/null
##OUTPUT=/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run-check-not/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run-check-not
##RCXFS_HIGH=N
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run-check-not.gnx,/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run-check-not.gdx
##XY_COORDINATES=c,r
##=======================================================
...
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
cd /media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run-check-not
...
vdbToRcx /media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT run-check-not -unit \
	meters -- -V1 -H satfile -r \
	/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run-check-not.xcn -df2 \
	-xgl
...
gnd
ENDCAT
sch2lay -a -r /media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run-check-not.gnx -rd /media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run-check-not.gdx sch_cap_ground lay_cap_ground
