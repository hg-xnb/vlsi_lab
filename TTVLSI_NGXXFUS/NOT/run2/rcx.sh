#!/bin/ksh
# This script was generated Mon May 12 09:05:08 2025 by:
#
...
#	/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run2.xcn -assura_run_dir \
#	/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT -assura_run_name run2 \
#	-rcxdir /media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run2 \
...
#	/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run2/extview.tmp \
...
#	/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run2.gnx,/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run2.gdx
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
...
##NETS_FILE=/dev/null
##OUTPUT=/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run2/extview.tmp
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run2.gnx,/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run2.gdx
##XY_COORDINATES=c,r
##=======================================================
...
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
cd /media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run2
...
/media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run2.xcn
ENDCAT
...
vdbToRcx /media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT run2 -unit meters -- -V1 \
	-H satfile -r /media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run2.xcn \
	-df2 -xgl
...
gnd
ENDCAT
sch2lay -a -r /media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run2.gnx -rd /media/ngxxfus/cds_work/TTVLSI_NGXXFUS/NOT/run2.gdx sch_cap_ground lay_cap_ground
