#!/bin/ksh
# This script was generated Fri Feb  7 15:03:46 2014 by:
#
...
#	/home/buet/cds_work/mylib2/nand2/run2.xcn -assura_run_dir \
#	/home/buet/cds_work/mylib2/nand2 -assura_run_name run2 -rcxdir \
#	/home/buet/cds_work/mylib2/nand2/run2 -xy_coordinates c,r -type full \
...
#	/home/buet/cds_work/mylib2/nand2/run2/extview.tmp -net_name_space \
...
#	microns -df2 -cap_models no -cap_ground z -cap_extract_mode decoupled \
#	-cap_coupling_factor 1.0 -array_vias_spacing auto -extract both -xref \
#	/home/buet/cds_work/mylib2/nand2/run2.gnx,/home/buet/cds_work/mylib2/nand2/run2.gdx
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
...
##AGDS_TEXT_LAYERS=
##ARRAY_VIAS_SPACING=
##ASSURA_RUN_DIR=/home/buet/cds_work/mylib2/nand2
##ASSURA_RUN_NAME=run2
...
##NETS_FILE=/dev/null
##OUTPUT=/home/buet/cds_work/mylib2/nand2/run2/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/buet/cds_work/mylib2/nand2/run2
##RCXFS_HIGH=N
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/home/buet/cds_work/mylib2/nand2/run2.gnx,/home/buet/cds_work/mylib2/nand2/run2.gdx
##XY_COORDINATES=c,r
##=======================================================
...
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
cd /home/buet/cds_work/mylib2/nand2/run2
...
/home/buet/cds_work/mylib2/nand2/run2.xcn
ENDCAT
...
vdbToRcx /home/buet/cds_work/mylib2/nand2 run2 -unit meters -- -V1 -H satfile \
	-r /home/buet/cds_work/mylib2/nand2/run2.xcn -df2 -xgl
...
z
ENDCAT
sch2lay -a -r /home/buet/cds_work/mylib2/nand2/run2.gnx -rd /home/buet/cds_work/mylib2/nand2/run2.gdx sch_cap_ground lay_cap_ground
...
advgen -V -g0 -li -f -n -o HSPICE -h ${HIERARCHY_DELIMITER} -TL L1T0 -cgnd \
	...
	/home/buet/cds_work/mylib2/nand2/run2/extview.tmp
